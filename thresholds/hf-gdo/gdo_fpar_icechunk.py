...
# ///
"""
GDO fAPAR Anomalies (VIIRS) — Download, subset EA, write to GCS Icechunk store
================================================================================
...
Source: https://drought.emergency.copernicus.eu/data/Drought_Observatories_datasets/
        GDO_Fraction_of_Absorbed_Photosynthetically_Active_Radiation_Anomalies_fAPAR_VIIRS/ver3-0-0/
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("gdo_fpar_icechunk.log"),
...
BASE_URL = (
    ...
    "GDO_Fraction_of_Absorbed_Photosynthetically_Active_Radiation_Anomalies_fAPAR_VIIRS/"
    "ver3-0-0/"
)
...
NC_FILES = [
    "fpanv_m_gdo_20120121_20121221_t.nc",
    "fpanv_m_gdo_20130101_20131221_t.nc",
    "fpanv_m_gdo_20140101_20141221_t.nc",
    "fpanv_m_gdo_20150101_20151221_t.nc",
    "fpanv_m_gdo_20160101_20161221_t.nc",
    "fpanv_m_gdo_20170101_20171221_t.nc",
    "fpanv_m_gdo_20180101_20181221_t.nc",
    "fpanv_m_gdo_20190101_20191221_t.nc",
    "fpanv_m_gdo_20200101_20201221_t.nc",
    "fpanv_m_gdo_20210101_20211221_t.nc",
    "fpanv_m_gdo_20220101_20221221_t.nc",
...
def subset_ea(nc_path):
    ...
    # Some files (2020, 2022, 2024, 2025) have near-duplicate lat values
    # (consecutive pairs differ by ~1e-14). Detect via rounded uniqueness
    # and fix by taking every other lat point.
        ...
        try:
            ...
            if is_new_store:
                ...
                ds_out = xr.Dataset(
                    ...
                    attrs={
                        "title": "GDO fAPAR Anomalies (VIIRS) - East Africa Subset",
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="GDO fAPAR Anomalies (VIIRS) EA -> GCS Icechunk store",
    )
